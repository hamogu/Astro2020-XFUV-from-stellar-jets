...
images for Winter 2005/06 (green) and for January 2010 (red), indicating jet longitudinal motion. Right: Calar Alto Potsdam Multi Aperture Spectrophotometer (PMAS) [S~{\sc ii}] image (green) superimposed on a smoothed X-ray image (red). From:\protect{\citet{2011ASPC..448..617G}}}
\label{fig:Xray}
\end{figure}
